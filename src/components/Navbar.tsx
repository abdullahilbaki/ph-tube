...
const SearchBar: React.FC<SearchBarProps> = ({ className = "", onSearch }) => {
  ...
  return (
    <div className="flex items-center justify-center">
      <div
        className={`${className} flex border-2 border-gray-300 rounded-full overflow-hidden w-full sm:w-auto`}
      >
        <input
          type="text"
          placeholder="Search..."
          className="w-full px-4 py-2 text-sm text-gray-700 bg-white outline-none"
